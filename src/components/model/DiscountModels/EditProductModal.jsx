...
const EditProductModal = ({
  ...
  const [productOptions, setProductOptions] = useState([]); // Options for product select
  const toast = useToast(); // Toast for notifications

  // API to fetch selected discount details
  useEffect(() => {
  ...
  // Fetch product options for the select dropdown
  useEffect(() => {
