...
//       initializeMap();
//     } else if (isVisible && mapRef.current) {
//       setIsMapLoaded(true);
//     }
...
// //import { useMap } from './MapContext'; // Import the context
...
//         console.log('initializing completed', newMap);

//         if (newMap && typeof newMap.on === 'function') {
//           setMap(newMap.Map); // Set the map in context
...
//       initializeMap();
//       setIsMapLoaded(true); 
//     } else if (isVisible && map && mapRef.current){
//       mapRef.current = map;
//       console.log(map)
//       setIsMapLoaded(true);  
//     }
...
//       centered
//     >
//       <div id="map" className="h-[500px] relative" ref={mapRef} >
//         <input
//           type="text"
//           id="auto"
//           name="auto"
