            ...
            <div className='pl-[300px] m-5 bg-gray-100'>
                ...
                <div className='bg-white mx-5 p-5 rounded-lg mt-5'>
                    ...
                    <div className='flex w-2/3 justify-between mt-5'>
                        <p>Enable this toggle to transfer Subscription on the basis of delivery methods.</p>
                        <Switch />
                    </div>
                    <div className='flex w-2/3 justify-between mt-10'>
                        <p>Merchant Subscription Setup</p>
                        <button className='bg-zinc-200 p-2 rounded-lg' onClick={showModal}>Add New Merchant Subscription Plan <PlusOutlined className='ml-10' /></button>
                        <Modal
                ...
                <div className='bg-white mx-5 p-5 rounded-lg mt-5'>
                    ...
                    <button className='bg-teal-800 w-1/3 p-2 text-white rounded-lg mt-5 ml-[33%]' onClick={submitMerchant}>Apply Subscription</button>
                </div>
            </div>
            ...
            <div className='pl-[300px] bg-gray-100'>
                ...
                <div className=' mx-5 p-5 rounded-lg mt-5'>
                    ...
                    <div className='flex w-2/3 justify-between mt-10'>
                        ...
                        <button className='bg-zinc-200 p-2 rounded-lg' onClick={showModalCustomer}>Add New Customer Subscription Plan <PlusOutlined className='ml-10' /></button>
                        <Modal
                            ...
                            footer={null}
                        >
                            <form onSubmit={signupActionCustomer} className='max-h-[30rem] overflow-auto'>
                                <div className="flex flex-col gap-4 mt-5">
                                    <div className="flex items-center">
                                        <label className="w-1/3 text-gray-500" htmlFor="Name">
                                            Name
                ...
                <div className='bg-white mx-5 p-5 rounded-lg mt-5'>
                    ...
                    <button className='bg-teal-800 w-1/3 p-2 text-white rounded-lg mt-5 ml-[33%]' onClick={submitCustomer}>Apply Subscription</button>
                </div>
            </div>
        </>
    )
