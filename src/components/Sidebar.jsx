...
const Sidebar = () => {
  ...
  return (
    <div className="fixed w-[250px] h-full bg-gradient-to-t from-teal-700 to-cyan-500 p-4 font-poppins">
      ...
      <div className="dropside">
        Marketing <CaretRightOutlined />
      </div>
      <div className="dropside">
        Notification <CaretRightOutlined />
      </div>
      <div className="dropside">
        Configure <CaretRightOutlined />
      </div>
      <div className="dropside">
        App Customization <CaretRightOutlined />
      </div>
      <div className="dropside">
        Account <CaretRightOutlined />
      </div>
    </div>
  );
};
