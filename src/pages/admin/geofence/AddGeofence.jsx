    ...
    <div className="w-full min-h-screen pl-[300px] bg-gray-100 flex flex-col">
         ...
         <div className="mt-8 p-6 bg-white  rounded-lg shadow-sm w-1/3 ms-10">
          <form onSubmit={signupAction}>
            <div  className='flex flex-col gap-3 '>
              <div>
              <label className="w-1/3 text-md font-medium" htmlFor='regionName'>Colour</label>
        ...
        <div className="absolute inset-y-0 right-0 flex items-center pr-3">
          <ColorLensOutlinedIcon className=" text-white text-[25px]" />
            ...
            <div>
              <label className="w-1/3 text-md font-medium" htmlFor='regionName'>Region name</label>
              <input
                type="text"
                name="regionName"
            ...
            <div>
              <label className="w-1/3 text-md font-medium" htmlFor='regionDescription'>Region description</label>
              <input
                type="text"
