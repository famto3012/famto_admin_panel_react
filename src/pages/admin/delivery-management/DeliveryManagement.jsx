...
const DeliveryManagement = () => {
    ...
    const steps = [
        { title: 'Merchant Name', description: 'by Admin ID #123', adress: '56, Post office, Pattom, Thiruvallam Lorem Ipsum Lorem Ipsum', pickup: 'delivery', time: "HH :MM" },
        { title: 'Cusotmer Name', description: 'by Admin ID #123', adress: 'PMG', pickup: 'delivery', time: "HH :MM" }
    ];
    ...
    return (
        <>
            ...
            <div className='p-5 pl-[75px] bg-gray-100'>
                <p className='text-[18px] font-semibold mt-5'> <ArrowLeftOutlined />{" "}Delivery Management</p>
                <div className='bg-white rounded-lg flex justify-between p-5 mt-5 '>
                    <div>
                        ...
                        <select
                            className='bg-blue-50 p-2 ml-5 rounded-md'
                            name='agent'
                        >
                    ...
                    <div className='flex gap-8 items-center'>
                        <SettingOutlined className='p-4 bg-blue-50 rounded-2xl' onClick={showModal} />
                        <Modal
                            onOk={showOkModal}
                                ...
                                <form onSubmit={submitSettings}>
                                    <div>
                                        <div className='flex justify-between mt-5'>
                                            <label className='text-[17px] font-semibold' >Request expires</label>
                                            <input
                                                type='text'
                                                name='expires'
                                            ...
                                            />
                                            <div>
                                                <p className='font-semibold text-[16px]'>sec</p></div>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <p className='text-gray-600 mt-5 text-[17px]'>Force assigns the task to Agent based on availability and distance</p>
                                            <div className='flex justify-between mt-5'>
                                                <label className='text-[17px] font-semibold' >Maximum Radius</label>
                                                <input
                                                    type='text'
                                                    name='maxRadius'
                                                ...
                                                />
                                                <div>
                                                    <p className='font-semibold text-[16px]'>Km</p></div>
                                            </div>
                                        </div>
                                        )}
                                        {selectedOption === "nearest-available" && (
                                            <p className='mt-5'>Sends the task request notification to the Agent (maximum limit: 500 Agent) available in the task time-slot. task gets assigned to the "Agent who accepts the task request first. If no Agent accepts the task, it remains unassigned."</p>)}
                                        <div className='grid'>
                                            <label className='text-[18px] mt-5 font-semibold'>Prioritize</label>
                                            ...
                                            <div className='flex'>
                                                ...
                                                <input
                                                    ...
                                                    checked={settings.prioritize === "Montly salaried employees"}
                                                /><p className='font-semibold text-[16px] ml-2'>Montly salaried employees </p>
                                            </div>
                                        </div>
                                        <div className='flex gap-4 mt-5'>
                                            <button onClick={showModalCancel} className='bg-blue-50 p-3 rounded-lg w-1/2 font-semibold'>Cancel</button>
                                            <button onClick={showOkModal} className='bg-teal-800 text-white p-3 w-1/2 rounded-lg'>Apply Auto Allocation</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <p>Auto Allocation {" "}<Switch onChange={onChange} /></p>
                    </div>
                </div>
                <div className='flex gap-2 mt-5'>
                    <div className='w-1/4 rounded-lg bg-white'>
                        <div className='bg-teal-800 text-white p-5 rounded-lg'>
                            Tasks
                        </div>
                        <div className='w-full p-2 mt-4'>
                            ...
                            >
                                <option value="task" hidden selected>Select Task</option>
                                <option value="unassigned">Unassigned Tasks <span className='bg-teal-800 p-2'> {" "}10</span></option>
                                        ...
                                        <Card className='bg-zinc-100 mt-5'>
                                            <CardBody>
                                                ...
                                                <Typography className="flex justify-between mt-3">
                                                    <Button className=' bg-gray-100 text-black text-[14px] font-semibold'>View on Map</Button>

                                                    {value ?
                                                        <div>
                                                            <Button className=' bg-teal-800 text-white text-[14px] font-semibold' onClick={showModalTask}>View Details</Button>
                                                            <Modal
                                                            ...
                                                            >
                                                                <div>
                                                                    ...
                                                                    <div>
                                                                        <p className='mt-5 text-lg font-semibold'>Task status</p>
                                                                        <div className='mt-5'>
                                                                                ...
                                                                                {steps.map((step, index) => (
                                                                                    <Step key={index} className='flex gap-5 size-20'>
                                                                                        ...
                                                                                        <Box flexShrink='0' className='ml-4'>
                                                                                            <StepTitle className='font-semibold text-[16px]'>{step.title}</StepTitle>
                                                                                            <StepDescription className='text-sm text-gray-500'>{step.description}</StepDescription>
                                                                                            <Step className='text-sm text-gray-500'>{step.adress}</Step>
                                                                                        </Box>
                                                                                        <Box flexShrink='0' className='ml-36'>
                                                                                            <Step>Expected Time {" "} {step.pickup}</Step>
                                                        ...
                                                        :
                                                        <div>
                                                            <Button className=' bg-teal-800  text-white text-[13px]  font-semibold' onClick={showModalAgent}>Assign Agent</Button>
                                                            <Modal
                                                                title="Assign Agent"
                                                            ...
                                                            >
                                                                <div>
                                                                    <div className='flex mt-5'>
                                                                        <label className='w-1/3 text-gray-600'>Task ID</label>
                                                                        <p className='font-semibold'>123</p>
                                                                    </div>
                                                                    <div className='flex mt-5'>
                                                                        <label className='w-1/3 text-gray-600'>Geofence</label>
                                                                        <p className='font-semibold'><Switch /></p>
                                                                    </div>
                                                                    <div className='flex mt-5 '>
                                                                        <label className='w-1/3 text-gray-600'>Agent</label>
                                                                        <select
                                                                    ...
                                                                    <div className='flex justify-end gap-5 mt-10'>
                                                                        <button className='bg-zinc-200 p-2 rounded-md px-4'>Cancel</button>
                                                                        <button className='bg-teal-800 text-white p-2 rounded-md px-4'>Assign Agent</button>
                                                                    </div>
                                                                </div>
                                                            </Modal>
                                                        </div>
                                ...
                                <Card className='bg-zinc-100 mt-5 flex'>
                                    <div className='flex justify-between'>
                                        ...
                                        <div className='w-1/3 flex justify-center items-center'>
                                            <p className='bg-teal-800 rounded-full p-3 text-white'>10</p>
                                        </div>
                                    </div>
                                </Card>
                            ))}
