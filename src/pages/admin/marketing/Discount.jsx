  ...
  const discount = [
    {
      ...
      value: "123",
      description:
        "description for testimng the sixe ff the tethdjfhyuhdfyergyuevgywiyuwytgwdvcgvewygvcqgdcvqgv",
            ...
            <form onSubmit={handleDiscountSubmit}>
              <div className="flex flex-col  gap-4 justify-between">
                <div className="flex gap-4">
                  ...
                  >
                    <option hidden selected defaultValue="Select Merchant">
                      Select Merchant
                    </option>
                    <option value="option 1">Option 1</option>
                    <option value="option 2">Option 2</option>
                    ...
                    <div className="flex gap-4">
                              ...
                              <div className="flex mt-5 gap-4">
                                <div>
                                  ...
                                  <input
                                    ...
                                    value="fixed"
                                    checked={
                                      productDiscount.discountType === "fixed"
                                    }
                                    onChange={handleInputChange}
                                  />
                                  Fixed discount
                      ...
                      >
                        ...
                        <div className="flex justify-end">
                          <button
                            className="bg-cyan-100 px-5 py-1 rounded-md font-semibold"
                            onClick={showModalDeleteCancel2}
                          >
                            Cancel
                          </button>
                          <button className="bg-red-100 px-5 py-1 rounded-md ml-3 text-red-700">
