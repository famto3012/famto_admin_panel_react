    ...
    return (
        <>
            ...
            <div className='pl-[300px] bg-gray-100 h-full'>
                ...
                <p className='mx-5 text-gray-500 mt-5'>Define referral code that customers can use to refer new customers coming on your platform. Referral code defined here is applied on checkout while placing the order. Note: Referrer - who shares; Referee - who receives</p>
                <form onSubmit={submitAction} className='bg-white p-10 rounded-lg'>
                    ...
                    <div className='mt-10'>
                        ...
                        <Switch className='ml-80' onChange={(checked) => onChange('status', checked)} name="status" />
                    </div>
                    <div className='flex'>
                        <label className='mt-10'>
                            Referral Code on Customers SignUp
                        </label>
                        <Switch className='ml-[108px] mt-10 ' onChange={(checked) => onChange('referalCodeOnCustomerSignUp', checked)} name="referalCodeOnCustomerSignUp" />
                    </div>
