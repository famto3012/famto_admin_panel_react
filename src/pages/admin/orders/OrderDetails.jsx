        ...
        <>
            ...
            <div className='pl-[300px] bg-gray-100 min-w-fit'>
                ...
                <div className='flex justify-between mx-5'>
                    <div> <p><ArrowLeftOutlined />{" "}Order information #123</p></div>
                    <div><button className='bg-blue-100 px-4 p-2 rounded-md'><DownloadOutlined />{" "}Bill</button></div>
                </div>
                ...
                <div className='mt-10'>
                    <h1 className='text-[18px] font-semibold ml-5 mb-5'>Customer Details</h1>
                ...
                <div className='mt-10'>
                    <h1 className='text-[18px] font-semibold ml-5 mb-5'>Merchant Details</h1>
                    <table className="w-full">
                        <thead>
                            <tr>
                                {[
                ...
                <div className='mt-10'>
                    <h1 className='text-[18px] font-semibold ml-5 mb-5'>Delivery Agent Details</h1>
                    <table className="w-full">
                        <thead>
                            <tr>
                                {[
