  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-100">
      <form className="bg-white p-8 rounded shadow-md " onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col gap-8">
          ...
          <label className=" w-1/3 text-gray-600">Commission setup</label>
            <input
              ...
              className="mr-2 ml-6"
            />
            <label htmlFor="fixed" className="w-[200px] text-gray-600">Set fixed amount (in₹)</label>
            <input
              type="radio"
              id="percentage"
              name="commissionType"
              ...
              className="mr-2"
            />
            <label htmlFor="percentage" className="w-[200px] text-gray-600">Set a percentage (%)</label>
          </div>
        
        <div className="flex items-center">
          <label htmlFor="merchantId" className="w-1/3 text-gray-600">Merchant ID</label>
          <input
            type="text"
            id="merchantId"
            name="merchantId"
        ...
        <div className="flex items-center">
          <label htmlFor="commissionValue" className="w-1/3 text-gray-600">Commission Value</label>
          <input
            type="text"
            id="commissionValue"
        ...
        <button
          type="submit"
          className="w-2/3  bg-teal-700 text-white py-2 rounded"
        >
          Apply Commission
        </button>
        </div>
