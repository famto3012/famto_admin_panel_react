    ...
    return (
        <>
            ...
            <div className='pl-[250px] bg-gray-100 h-screen w-full'>
                <nav className='p-7'><GlobalSearch /></nav>
                <div className='flex justify-between mt-5 px-5'>
                    <h1 className='font-bold text-[20px]'> Managers</h1>
                    <Link to="/addmanager" > <button className='bg-teal-800 rounded-md py-2 px-5 text-white'><PlusOutlined />{""}Add Manager</button></Link>
                </div>
                    ...
                    <tbody>
                        {dummyData.map((dummyData) => (
                            <tr className='text-center bg-white h-20' key={dummyData.id}>
                                ...
                                <td>
                               <button ><EditOutlined className='bg-gray-200 p-3 mr-2 rounded-lg' />
                                </button>
