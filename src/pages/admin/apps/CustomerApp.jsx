...
import { GoogleOutlined, AppleFilled, EditOutlined, DeleteOutlined, PlusOutlined, FacebookFilled } from '@ant-design/icons'
...
const CustomerApp = () => {
    ...
    const [isModalVisibleBannerEdit, setIsModalVisibleBannerEdit] = useState(false);
    ...
    const [isModalVisibleBuinessEdit, setIsModalVisibleBusinessEdit] = useState(false);
            ...
            <div className='pl-[300px] bg-gray-100 p-5'>
                ...
                <div className='flex gap-10 mt-10 mx-5  border-b-2 border-gray-200 pb-5'>
                    ...
                    <div className='text-gray-500'>
                        Note: The purpose is to wish or design the splash page. The format can image or gif Note: Design according to aspect ratio
                    </div>
                ...
                <div className='flex mx-5 mt-10 gap-10  border-b-2 border-gray-200 pb-5'>
                    ...
                    <div className='text-gray-500'>
                        Control sign-up of Customer on your platform. Here you are given with a variety of options such as whether to have email or phone number as mandatory fields on the sign-up form, how do you want to verify the Customer: via Email verification or OTP verification and which social platform you want to enable through which Customer can sign up on your platform.
                        <div className='flex gap-16 mt-5'>
                            <div className='bg-white p-7 grid rounded-lg mt-20'>
                                <label className='font-semibold'>Required fileds on signup</label>
                                <div> Phone No.<Switch className='ml-5' onChange={(checked) => onChange("phoneno", checked)} name="phoneno"
                                /></div>
                                <div>Email <Switch className='ml-14' onChange={(checked) => onChange("email", checked)} name="email" /></div>
                            </div>
                            <div className='bg-white p-5 grid rounded-lg mt-20'>
                                <label className='font-semibold'>Signup Verification</label>
                                <div>Email verification<Switch className='ml-5' onChange={(checked) => onChange("emailverify", checked)} name="emailverify" /></div>
                                <div>OTP verification <Switch className='ml-6' onChange={(checked) => onChange("otpverify", checked)} name="otpverify" /></div>
                            </div>
                            <div className='bg-white p-5 gap-5 grid rounded-lg'>
                                <label className='font-semibold'>Login via</label>
                                <div>OTP<Switch className='ml-32' onChange={(checked) => onChange("otp", checked)} name="otp" /></div>
                                <div><GoogleOutlined className='text-[30px]' /><Switch className='ml-[125px]' onChange={(checked) => onChange("google", checked)} name="google" /></div>
                                <div><AppleFilled className='text-[30px]' /><Switch className='ml-[125px]' onChange={(checked) => onChange("ios", checked)} name="ios" /></div>
                                <div><FacebookFilled className='text-[30px]' /><Switch className='ml-[125px]' onChange={(checked) => onChange("facebook", checked)} name="facebook" /></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className='border-b-2 border-gray-200 pb-5'>
                    <div className='flex justify-between mx-5 mt-10'>
                        <h1>Services</h1>
                        <p className='text-gray-500'>This enables to add, edit, change thumbnail of the listed services</p>
                        <button
                            onClick={showModal}
                            ...
                            <form onSubmit={handleService}>
                                ...
                                <div className="flex mt-5  gap-4">
                                    ...
                                    <select
                                        ...
                                        className="border-2 border-gray-300 rounded p-2 focus:outline-none w-2/3"
                                    >
                                        <option value="select" hidden selected>Geofence</option>
                    ...
                    <div className='grid justify-center mt-5'>
                        <div className='w-96 h-48'>
                            <div className=" bg-gray-300 rounded-lg">
                                <div className="flex relative ">
                                    ...
                                    <img className="ml-3 rounded" src="Delivery-card.svg" alt="" />
                                    <p className="text-white absolute bottom-1 right-1">Delivery</p>
                                </div>
                            </div>
                        </div>
                        <div className='w-96 h-48'>
                        ...
                        <div className='w-96 h-48'>
                            <div className=" bg-gray-300 rounded-lg">
                                <div className="flex relative ">
                                    <DragIndicatorIcon className='mt-14 text-3xl ml-3' />
                                    <img className="ml-3 rounded" src="OnlineConsultation-card.svg" alt="" />
                                    <p className="text-white absolute w-16 bottom-1 right-6">Online Consultation</p>
                                </div>
                            </div>
                        </div>
                        <div className='w-96 h-48'>
                            <div className=" bg-gray-300 rounded-lg">
                                <div className="flex relative ">
                                    <DragIndicatorIcon className='mt-14 text-3xl ml-3' />
                                    <img className="ml-3 rounded" src="HandymanServices-card.svg" alt="" />
                                    <p className="text-white w-16 absolute bottom-1 right-2 text-end">Handyman Services</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className='flex justify-between mx-5 gap-10 mt-10'>
                    ...
                    <p className='text-gray-500 w-[900px]'>Business Categories provide your merchants the power to map their categories/products to a business category, which in turn will help the customers to easy checkout.</p>
                    <div>                    <button
                            ...
                            <form onSubmit={handleBusiness}>
                                ...
                                <div className="flex">
                                    ...
                                    <div className=" flex items-center gap-[30px]">
                                        ...
                                        />
                                        <label htmlFor="businessEditImage" className="cursor-pointer ">
                                            <MdCameraAlt
                                                className=" bg-teal-800  text-[40px] text-white p-6 h-16 w-16 mt-5 rounded"
                                                size={30}
                                            />
                ...
                <div className='mt-10 justify-between flex mx-5 border-b-2 pb-10 mb-5 border-gray-200'>
                    ...
                    <p className='w-[43rem] text-gray-500'>Enable this, to restrict Customer from accessing the platform without logging in into the platform. (Make sure your apps are updated).</p>
                    <Switch />
                </div>
                <div className='mt-10 justify-between flex mx-5'>
                    <h1>Customer Order Banners (info)</h1>
                    <p className='w-[45rem] text-gray-500'>The Purpose of this banner is to educate customer.</p>
                    <Switch />
                </div>
                ...
                <div className='grid grid-cols-2 ml-[335px] w-[61%] mt-10  gap-5'>
                    <Card>
                        ...
                        <img src='Sadhya.svg' />
                        <button className='bg-blue-50 rounded-3xl p-3 px-12 mt-5' onClick={showModalBannerEdit}><EditOutlined /> Edit</button>
                        <Modal
                            title="Add Banner"
                        ...
                        <button className='bg-teal-800 rounded-3xl p-3 text-white ml-5 px-12 mt-5'><DeleteOutlined />Delete</button>
                    </Card>
                    ...
                    <Card>
                        ...
                        <p>Description</p>
                        <img src='Sadhya.svg' />
                        <button className='bg-blue-50 rounded-3xl p-3 px-12 mt-5'><EditOutlined /> Edit</button>
                        <button className='bg-teal-800 rounded-3xl p-3 text-white ml-5 px-12 mt-5'><DeleteOutlined />Delete</button>
                    </Card>
