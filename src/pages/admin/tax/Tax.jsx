  ...
  return (
    <>
      ...
      <div className='pl-[250px] w-full'>
          ...
          >
            ...
            <form onSubmit={submitAction}>
              <div className='flex flex-col  gap-4 justify-between'>
                ...
                <div className="flex gap-4">
                  <label className="w-1/2 text-gray-500">Assign to Merchant</label>
                  <select
                    className="border-2 border-gray-300 rounded p-2 w-2/3"
                    name='merchant'
                    value={tax.merchant}
                ...
                <div className="flex justify-end  gap-4">
                  <button className='bg-gray-300 rounded-lg px-6 py-2 font-semibold justify-end' onClick={handleCancel} type='submit'>Cancel</button>
                  <button className='bg-teal-800 rounded-lg px-6 py-2 text-white font-semibold justify-end' onClick={handleOk} type='submit'>Save</button>
                </div>
              </div>
            </form>
          </Modal>
        ...
        <p className='ms-5 mt-8 text-gray-500'>Make sure that taxes aren't duplicated under the same name on the platform.<span className='text-red-700'> Two taxes under the same name cannot coexist.</span></p>
            ...
            <tbody className='bg-white'>
              ...
              <tr key={tax.id}>
                ...
                <td className="py-5 px-4 border-b flex gap-3 justify-end border-gray-100">
                  ...
                  />
                  <div>
                    <button onClick={showModalEdit}><EditOutlined className='bg-gray-200 p-3 rounded-lg' />
                    </button>
                    <Modal
                      title="Edit Tax"
                    ...
                    >
                      ...
                      <form onSubmit={submitAction}>
                        <div className='flex flex-col  gap-4 justify-between'>
                          ...
                          <div className="flex justify-end  gap-4">
                            <button className='bg-gray-300 rounded-lg px-6 py-2 font-semibold justify-end' onClick={handleCancelEdit} type='submit'>Cancel</button>
                            <button className='bg-teal-800 rounded-lg px-6 py-2 text-white font-semibold justify-end' onClick={handleOkEdit} type='submit'>Save</button>
                          </div>
                        </div>
                      </form>
                    </Modal>
