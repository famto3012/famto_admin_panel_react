        ...
        <div className="flex items-center justify-between mt-7 border-b-2 border-gray-200 pb-10">
           ...
           <p className="text-gray-500 ">Note: The purpose is to wish or design the splash page. The format can image or gif {" "}
            <span className='flex justtify-start'> Note: Design according to aspect ratio </span></p>
                    ...
                    <div className='text-gray-500 mx-[168px] '>Control sign-up of agent on your platform. Here you are given with a variety of options such as whether to have email orphone number as mandatory fields on the sign-up form, how do you want to verify the agent: via Email verification or OTP verification and which social platform you want to enable through which agent can sign up on your platform.</div>
                    ...
                    <p className='text-gray-500 mr-[100px]'>Enable this, to restrict Agent from accessing the platform without logging in into the  <span className='flex justtify-start'>platform. (Make sure your apps are updated).</span></p>
                    <div className='mx-10'>
                        <Switch />
                    </div>
                    </div>
