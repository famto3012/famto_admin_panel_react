     ...
     <Sidebar />
      <div className="w-fit min-h-screen pl-[290px] bg-gray-100">
        ...
        <div className="flex items-center justify-between mt-7 border-b-2 border-gray-300 pb-10">
           ...
           <p className="text-gray-500 ">Note: The purpose is to wish or design the splash page. The format can image or gif {" "}
            <span className='flex justtify-start'> Note: Design according to aspect ratio </span></p>
                    ...
                    <div className='text-gray-500 mx-[165px] '>Control sign-up of agent on your platform. Here you are given with a variety of options such as whether to have email orphone number as mandatory fields on the sign-up form, how do you want to verify the agent: via Email verification or OTP verification and which social platform you want to enable through which agent can sign up on your platform.</div>
                    ...
                    <label className="text-gray-500">Phoneno</label>
                     <Switch className='ml-[54px]' onChange={(checked) => onChange('phoneno', checked)} name="phoneno" />
                    </div>
                    <div className="flex items-center mt-5">
                    <label className="text-gray-500">Email</label>
                     <Switch className='ml-20' onChange={(checked) => onChange('email', checked)} name="email" />
                    </div>
                    </div>
                    <div className='mt-12 mx-6'>
                    ...
                    <label className="text-gray-500">Email Verification</label>
                     <Switch className='ml-10' onChange={(checked) => onChange('emailverify', checked)} name="emailverify"/>
                    </div>
                    <div className="flex items-center mt-5">
                    <label className="text-gray-500">OTP Verification</label>
                     <Switch className='ml-12' onChange={(checked) => onChange('otpverify', checked)} name="otpverify" />
                    </div>
                    </div>
                    ...
                    <label className="text-gray-500">OTP</label>
                     <Switch className='ml-20' onChange={(checked) => onChange('otp', checked)} name="otp" />
                    </div>
                    <div className="flex items-center mt-5">
                    <FaGoogle  className='text-gray-500 text-[25px]'/>
                     <Switch className='ml-[84px]' onChange={(checked) => onChange('google', checked)} name="google" />
                    </div>
                    <div className="flex items-center mt-5">
                    <AiFillApple className='text-gray-500 text-[30px]'/>
                     <Switch  className='ml-[80px]' onChange={(checked) => onChange('ios', checked)} name="ios"/>
                    </div>
                    <div className="flex items-center mt-5">
                    <FaFacebookSquare className='text-gray-500 text-[30px]'/>
                    <Switch className='ml-[80px]' onChange={(checked) => onChange('facebook', checked)} name="facebook"/>
                    </div>
                    </div>
                    ...
                    <p className='text-gray-500 mr-[70px]'>Enable this, to restrict Agent from accessing the platform without logging in into the  <span className='flex justtify-start'>platform. (Make sure your apps are updated).</span></p>
                    <div className='mx-10'>
                        <Switch />
                    </div>
                    </div>
                    <div className="flex justify-end gap-4 mt-10 mx-10">
                  <button
